      ...
      <el-tabs tab-position="left" type="border-card" style="height: 700px;">
        <el-tab-pane label="我的信息">
          ...
          <el-col :span="8" class="item-list">
            ...
            <el-card shadow="never" class="item-lists">
              <el-input placeholder="请输入内容" v-model="userMsg.nick_name">
        ...
        <el-tab-pane label="修改密码">
          <el-col :span="8" class="item-list">
            ...
            <el-card shadow="never" class="item-lists">
              <el-input class="item-input" placeholder="请输入内容" v-model="newPwd" type="password">
                <template slot="prepend">新密码</template>
              </el-input>
            </el-card>
            <el-card shadow="never" class="item-lists">
              <el-input class="item-input" placeholder="请输入内容" v-model="newPwd2" type="password">
                <template slot="prepend">确认密码</template>
              </el-input>
            </el-card>
            <el-card shadow="never" class="item-lists">
              <el-col :span="8">
                <el-input class="item-input" placeholder="请输入内容" v-model="sms_code">
                  <el-button slot="append" @click="getCode">获取验证码</el-button>
                </el-input>
              </el-col>
            </el-card>
            <el-button type="danger" plain @click="reset">确认修改</el-button>
          </el-col>
        </el-tab-pane>
        <el-tab-pane label="我的贴子">
          ...
          <div class="aList" v-loading="loading1">
            ...
            <div class="pagination">
              <el-pagination @current-change="goNote" layout="prev, pager, next" :total="noteNo">
              </el-pagination>
            </div>
          </div>
        </el-tab-pane>
        <el-tab-pane label="我的收藏">
          ...
          <div class="aList" v-loading="loading2">
            ...
            <div class="pagination">
              <el-pagination @current-change="goCol" layout="prev, pager, next" :total="collNo">
              </el-pagination>
            </div>
          </div>
        </el-tab-pane>

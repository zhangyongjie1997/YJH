<template>
  <div id="container" class="container">
    ...
    <div class="handle-div">
      ...
      <div class="share">
        <el-popover placement="top-start" title="扫描二维码分享" width="200" trigger="hover">
          <img src="../assets/logo.png">
          <el-button slot="reference">分享
            ...
            <tr width="100%">
              <td colspan="4">
                <div :ref="index" class="resCom">
                  ...
                  <el-button @click="hideRes(index)" class="el-Btn resBtn" size="mini" type="danger" plain>取消</el-button>
                </div>
              </td>
            </tr>
          </tbody>
